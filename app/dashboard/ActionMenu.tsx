  ...
  return (
    <div className="absolute top-4 right-4 flex space-x-2 z-20">
      <form action={blockUser.bind(null, senderId)}>
        <button 
          type="submit" 
          className="text-xs font-medium text-slate-500 hover:text-rose-600 hover:bg-rose-50 border border-slate-200 hover:border-rose-200 px-3 py-1.5 rounded-lg bg-white shadow-sm cursor-pointer transition-all"
          onClick={(e) => {
